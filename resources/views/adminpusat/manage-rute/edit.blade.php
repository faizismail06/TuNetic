            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-warning card-outline">
                        ...
                        <div class="card-body">
                            <form action="{{ route('manage-rute.update', $rute->id) }}" method="POST">
                                @csrf
                                @method('PUT')

                                <div class="form-group mb-3">
                                    <label for="name">Nama</label>
                                    <input type="text" class="form-control" name="name" value="{{ $rute->nama_rute }}">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="tanggal_lahir">Tanggal Operasional</label>

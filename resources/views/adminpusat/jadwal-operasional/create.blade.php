        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-success card-outline">
                    ...
                    <div class="card-body">
                        <form id="wizardForm" method="POST" action="{{ route('jadwal-operasional.store') }}">
                            @csrf
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="id_armada" class="form-control" required>
                                            ...
                                            @foreach($armadas as $armada)
                                                <option value="{{ $armada->id }}">{{ $armada->jenis_kendaraan }} - {{ $armada->no_polisi }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                            ...
                            <div id="step-2" style="display: none;">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary mr-2" onclick="prevStep()">Kembali</button>

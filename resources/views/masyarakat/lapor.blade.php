...
<link href="https://fonts.googleapis.com/css2?family=Red+Hat+Text:wght@400;500;550;600;700&display=swap" rel="stylesheet">
...
<div class="main-wrapper">
    <div class="form-wrapper">
        ...
        <form action="{{ route('masyarakat.lapor.submit') }}" method="POST" enctype="multipart/form-data">
            ...
            <label for="judul" style="font-size: 1rem; margin-top: 30px; font-weight: 550; display: block;">Judul Laporan</label>
            <input type="text" name="judul" id="judul" placeholder="Masukkan judul laporan" autocomplete="off">
            
            <label for="gambar" style="font-size: 1rem; margin-top: 20px; font-weight: 550; display: block;">Upload Foto</label>
            ...
            <label for="deskripsi" style="font-size: 1rem; margin-top: 20px; font-weight: 550; display: block;">Deskripsi</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show/hide input "Lainnya"
    document.getElementById('jenis_masalah').addEventListener('change', checkMasalahLainnya);
...
<style>
    /* (copy-paste CSS-mu yang sudah bagus di sini, tidak perlu diubah) */
    body {

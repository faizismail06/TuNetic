                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="tel" class="form-control @error('no_telepon') is-invalid @enderror"
                                        id="no_telepon" name="no_telepon" pattern="[0-9]+"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select name="regency_id" id="regency"
                                        class="form-select @error('regency_id') is-invalid @enderror" required>
                                        <option value="">Pilih Kabupaten/Kota</option>
                                        @if ($user && $user->regency_id && $user->regency)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select name="district_id" id="district"
                                        ...
                                        @if ($user && $user->district_id && $user->district)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select name="village_id" id="village"
                                        class="form-select @error('village_id') is-invalid @enderror" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" 
                                        name="alamat" rows="3" placeholder="Contoh: Jl. Merdeka No. 10, RT 05/RW 02" required>{{ old('alamat', $user->alamat ?? '') }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Masukkan alamat lengkap beserta RT/RW</small>
                                </div>
                            </div>
...
@push('css')
    ...
    <style>
        ...
        .colored-input:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(207, 233, 210, 0.5) !important;
            color: #155724 !important;
        }
        ...
        $(document).ready(function() {
            ...
            function showLoading() {
                if ($('.loading-overlay').length === 0) {
                    $('body').append('<div class="loading-overlay d-flex"><div class="spinner"></div></div>');
                }
            ...
            $('form').on('submit', function(e) {
                // Validasi form
                let isValid = true;
                const requiredFields = ['name', 'no_telepon', 'province_id', 'regency_id', 'district_id', 'village_id', 'alamat'];
                ...
                requiredFields.forEach(function(field) {
                    ...
                    if (!element.val() || element.val().trim() === '') {
                        ...
                        if (!element.next('.invalid-feedback').length) {
                            element.after('<div class="invalid-feedback">Field ini harus diisi</div>');
                        }
                    } else {
            ...
            $('#no_telepon').on('input', function() {
                ...
                // Remove validation error if number is entered
                if (value.length > 0) {
            ...
            // Handle page refresh/redirect after form submission

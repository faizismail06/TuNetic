            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Auto-Tracking Lokasi Petugas</h5>
                    </div>
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        @else
                            <div class="tracking-info">
                                <p>
                                    <strong>Petunjuk:</strong> Sistem akan otomatis mengambil lokasi perangkat Anda setiap 5
                                    detik dan mengirimkannya ke server selama tracking aktif. Pastikan GPS perangkat Anda
                                    aktif.
                                </p>
                                <div class="mt-2">
                            ...
                            <div id="status-container" class="mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span id="tracking-status">Tracking tidak aktif</span>
                                </div>
                                <small id="location-info" class="text-muted"></small>
                            </div>

                            <div>
                                <h6>Jadwal Operasional Anda:</h6>
                                @foreach ($jadwalOperasional as $jadwal)
                                    <div class="card jadwal-card">
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-sm btn-outline-primary show-tps-button mb-2"
                                            ...
                                            <div class="btn-group jadwal-buttons" data-id="{{ $jadwal->id }}"
                                                ...
                                                @if ($jadwal->status == 0)
                                                    <button class="btn btn-success btn-sm start-tracking">Mulai
                                                        Tracking</button>
                                                @elseif($jadwal->status == 1)
                                                    <button class="btn btn-primary btn-sm start-tracking active">Tracking
                                                        Aktif</button>
                                                    <button class="btn btn-danger btn-sm finish-tracking">Selesai</button>
                                                    <div class="tracking-counter mt-2 small text-muted">Update ke-0</div>
                                                @else

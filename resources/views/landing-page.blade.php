...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Red+Hat+Text:wght@100;300;400;700;900&display=swap" rel="stylesheet">
    ...
    <section id="tps" class="position-relative overflow-hidden">
        ...
        <section class="py-5 position-relative" id="jadwal">
            <div class="container">
                ...
                <p class="fw-medium mb-4" style="font-family: 'Red Hat Text', sans-serif;">
        Lihat dan Pantau Jadwal Penjemputan Sampah
                </p>
...
<body>
    ...
    <section id="tps" class="position-relative overflow-hidden">
        <div class="tps-wrapper text-white position-relative z-1">
            ...
            <!-- TPS Cards -->
            <div class="row g-4">
                @foreach($namaTpsAktif as $namaTps)
                    <div class="col-md-4 col-sm-6">
                        <div class="tps-card">
                            <img src="{{ asset('assets/images/sampahtps.png') }}" alt="TPS Icon" class="tps-icon">
                            <p class="tps-title">{{ $namaTps }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <!-- Lihat Semua -->
            <a href="{{ route('tps.index') }}" class="lihat-semua">Lihat Semua →</a>
        </div>

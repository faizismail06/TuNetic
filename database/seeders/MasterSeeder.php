    ...
    public function run()
{
    ...
    foreach (['create_user', 'read_user', 'update_user', 'delete_user'] as $perm) {
        Permission::firstOrCreate(['name' => $perm], ['menu_id' => $menu_id->id]);
    }
    ...
    Permission::firstOrCreate(['name' => 'backup_database'], ['menu_id' => $menu_id->id]);

    // Role & Role-Menu Mapping
